...
public interface IAyahRepository
{
    ...
    Task<int?> GetIdByPositionAsync(byte surahId, short numberInSurah, CancellationToken ct = default);
    ...
    Task<int> CountArabicSearchAsync(string normalizedQuery, CancellationToken ct = default);
}
